...
(function () {
    ...
    function Ra(a) {
        if (!Aa) {
            var c = !1,
                b = !1;
            "undefined" === typeof ba.Chart.creditHref ? (a.creditHref = "", a.creditText =
                "") : (c = a.updateOption(""), b = a.updateOption(""));
    ...
    var A = {},
        ...
        sa = 1,
        P = Na ? za / sa : 1,
        Aa = window && window.location && window.location.href && window.location.href.indexOf && (-1 !== window.location.href.indexOf("") || -1 !== window.location.href.indexOf("fenopix.com") || -1 !== window.location.href.indexOf("fiddle")),
        Sa = {
            reset: {
