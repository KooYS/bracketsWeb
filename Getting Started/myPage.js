...
$(document).ready(function () {
    $(".mapWrap.lazy").click(function () {
     ...
     $('#chart1').css({left:-900,top:0});
     $('#chart2').css({left:-900,top:0});
     $('.chart').css({left:-900,top:0});
     $('.chart').css('display','none');
    
    $('#chart1').css('display','none');
   $('#chart2').css('display','none');
    
     $('#first_pic').css({left:-900,top:0});
     $('#second_pic').css({left:-900,top:0});
     $('#fourth_pic').css({left:-900,top:0});
     $('.un_chart_container').css({left:-900,top:0});
   $('#first_pic').css('display','none');
   $('#second_pic').css('display','none');
   $('#fourth_pic').css('display','none');
   $('.un_chart_container').css('display','none');
});
...
new ScrollMagic.Scene({
    ...
    .on("progress", function (e) {
        ...
        if (e.progress == 0) {
             ...
             $('.un_chart_container').css('position','relative').animate({
                left: '-900',
            },500, function(){
                $('.chart').css('display','none');
        ...
        if (e.progress == 1) {
            ...
            $('#chart2').css('position','relative').animate({
                left: '-900',
                 ...
                 $('.un_chart_container').css('display','block');
                $('.un_chart_container').css('position','relative').animate({
                left: '0',
            },
                500);
...
new ScrollMagic.Scene({
        triggerElement: "#fourth_pic_trigger"
    })
    .addTo(controller)
    .addIndicators() // add indicators (requires plugin)
    .on("progress", function (e) {
        ...
        // $("#progress").text(e.progress.toFixed(3));
        if (e.progress == 0) {
             $('#fourth_pic').css('position','relative').animate({
                left: '-900',
