  ...
  function fade() {
      ...
      Area.context.drawImage(Warn, 0, 0, 800, 480);
  }
  ...
  var Menu = {
      init: function () {
          ...
          MenuBackground = new Component(this, 800, 480, "/images/log2.jpg", 0, 0, "background");
          MenuButton = new Component(this, 128, 128, "/images/start.png", 400 - 64, 350, "image");
          MenuTitle = new Component(this, 256, 128, "/images/title.png", 400 - 128, 50, "image");
  ...
  var Over = {
      init: function () {
          ...
          OverBackground = new Component(this, 800, 480, "/images/over.jpg", 0, 0, "background");
          OverButton = new Component(this, 128, 128, "/images/start.png", 400 - 64, 350, "image");
          OverTitle = new Component(this, 256, 128, "/images/title.png", 400 - 128, 50, "image");
      },
      start: function () {
  ...
  var Area = { // 게임 캔버스      
      init: function () {
          ...
          Background = new Component(this, 800, 480, "/images/log.jpg", 0, 0, "background");
          ...
          for (var i = 0; i < fishNum; i++) {
              myObject.push(new Component(this, 78, 78, "/images/fish_1.png", 0 + i * 78, 0 - (Math.random() * 100) * 30, "image"));
          }
          for (var i = 0; i < fishDieNum; i++) {
              myObject2.push(new Component(this, 78, 78, "/images/fish_2.png", 0 + i * 78 * 2, 0 - (Math.random() * 100) * 20, "image"));
          }
          ...
          hero.push(new Animation(2560, 512, 1, 5, 5, "/images/pe.png", 500, 350, 350, 0.25));
          hero.push(new Animation(2560, 512, 1, 5, 5, "/images/pe_l.png", 500, 350, 350, 0.25));
          hero.push(new Animation(2560, 512, 1, 5, 5, "/images/pe_1.png", 500, 350, 350, 0.25));
          hero.push(new Animation(2560, 512, 1, 5, 5, "/images/pe_1_l.png", 500, 350, 350, 0.25));
  ...
  function updateArea() {
      ...
      for (var i = 0; i < fishNum; i++) {
          if (hero[currentType].crash(myObject[i]) && Area.crashCheck == false) {
              Area.scoreCount += 50;
              myObject[i].y = 0 - (Math.random() * 100) * 30;
      ...
      for (var i = 0; i < fishDieNum; i++) {
          if (hero[currentType].crash(myObject2[i]) && Area.crashCheck == false) {
              Area.scoreCount -= 50;
              myObject2[i].y = 0 - (Math.random() * 100) * 20;
